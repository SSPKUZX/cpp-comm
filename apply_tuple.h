...
template <typename... Tuples>
using MakeIndexSequenceFromTuple = utl::MakeIndexSequence<
...
inline constexpr auto call(F&& f, Tuple&& t, utl::IndexSequence<Indexes...>)
    -> decltype(
...
inline constexpr auto forwardTuple(Tuple&& t, utl::IndexSequence<Indexes...>)
    -> decltype(
